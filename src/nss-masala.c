...
enum nss_status _nss_masala_gethostbyname_r(
		const char *hostname, struct hostent *host,
		char *buffer, size_t buflen, int *errnop,
		int *h_errnop ) {

	return _nss_masala_gethostbyname3_r(
			hostname, AF_UNSPEC, host,
			buffer, buflen,
			errnop, h_errnop,
			NULL, NULL);
}

enum nss_status _nss_masala_gethostbyname2_r(
...
enum nss_status _nss_masala_gethostbyname3_r(
		const char *hostname, int af, struct hostent *host,
		char *buffer, size_t buflen, int *errnop,
...
enum nss_status _nss_masala_gethostbyname4_r(
		const char *hostname,
	...
	return _nss_masala_gaih_tuple(
			hostname, pat, buffer,
			buflen, errnop, 
			h_errnop, ttlp);
}

enum nss_status _nss_masala_hostent(
		const char *hostname, int af, struct hostent *host,
		char *buffer, size_t buflen, int *errnop,
		int *h_errnop, int32_t *ttlp, char **canonp ) {
...
enum nss_status _nss_masala_gaih_tuple(
