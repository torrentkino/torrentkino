...
void http_200(TCP_NODE * n, char *lastmodified,
	      char *filename, size_t filesize, char *keepalive,
	      const char *mimetype);
void http_206_simple(TCP_NODE * n, RESPONSE * r_head, RESPONSE * r_file,
		     ...
		     const char *mimetype);
void http_206_complex(TCP_NODE * n, RESPONSE * r_head, char *lastmodified,
		      char *filename, size_t filesize, size_t content_length,
		      char *boundary, char *keepalive);
